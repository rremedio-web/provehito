...
contributor machines, CI, and release archives compile with the same patch.
Install that toolchain before running `scripts/acceptance.sh`. The pin is for
build identity, not a claim that the code uses 1.26.7-only language features.
